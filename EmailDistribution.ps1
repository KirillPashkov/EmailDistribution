...
function Call-MainForm_psf
{
	...
	$groupboxMessage = New-Object 'System.Windows.Forms.GroupBox'
	$richtextboxText = New-Object 'System.Windows.Forms.RichTextBox'
	$checkboxAsHTML = New-Object 'System.Windows.Forms.CheckBox'
	$trackbarFontSize = New-Object 'System.Windows.Forms.TrackBar'
	$buttonStartJobSend = New-Object 'System.Windows.Forms.Button'
	...
	$labelBcc = New-Object 'System.Windows.Forms.Label'
	$textboxBcc = New-Object 'System.Windows.Forms.TextBox'
	$labelCc = New-Object 'System.Windows.Forms.Label'
	$textboxCc = New-Object 'System.Windows.Forms.TextBox'
	$labelAttachments = New-Object 'System.Windows.Forms.Label'
	...
	$groupboxConfiguration = New-Object 'System.Windows.Forms.GroupBox'
	$labelGUILanguage = New-Object 'System.Windows.Forms.Label'
	$checkboxSave = New-Object 'System.Windows.Forms.CheckBox'
	$comboboxLanguages = New-Object 'System.Windows.Forms.ComboBox'
	...
	#----------------------------------------------
	$OnLoadFormEvent = {
		if (-not (Test-Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access'))
		{ New-RegistryKeys -New }
		'Русский', 'English' | % { Load-ComboBox -ComboBox $comboboxLanguages -Items $_ -Append }
		$comboboxLanguages.SelectedIndex = 1
		[System.Text.Encoding]::GetEncodings() | Select-Object -ExpandProperty Name | % { Load-ComboBox -ComboBox $comboboxEncodings -Items $_ -Append}
		$comboboxEncodings.SelectedIndex = ($comboboxEncodings.Items.Count - 1)
		'Low', 'Normal', 'High' | % { Load-ComboBox -ComboBox $comboboxPriority -Items $_ -Append }
	...
	$buttonStartJobSend_Click = {
		if ($textboxSmtpServer.Text.Trim() -ne '' -and $textboxFrom.Text.Trim() -ne '' -and $textboxTo.Text.Trim() -ne '' -and $textboxSubject.Text.Trim() -ne '')
		{
			...
			if ($checkboxAsHTML.Checked) { $BodyAsHTML = $true }
	...
	$trackbarFontSize_Scroll={
		$richtextboxText.Font = New-Object -TypeName System.Drawing.Font('Microsoft Sans Serif', $($trackbarFontSize.Value))
		if ($checkboxSave.Checked) { Set-Registry }
	}
...
AT8E/wH8AT8B/AE/Cw=='))
	...
	function New-RegistryKeys
	{
		...
		if ($New)
		{
			...
			[void](New-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\General' -Name UpdateServer -Value 'wgo-it000000601' -PropertyType String)
		...
		[void](New-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Settings' -Name DisplayName -Value '' -PropertyType String -Force)
	...
	function Check-Updates
	{
		Add-JobTracker -Name "JobName" `
			...
			try
			{
				...
				[version]$check = $nc.DownloadString("http://$(Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\General' -Name UpdateServer | Select -ExpandProperty UpdateServer)/software/smtp/version.txt")
				[version]$current = Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\General' -Name Version | Select -ExpandProperty Version
				if ($check -gt $current)
				{ $nc.DownloadString("http://$(Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\General' -Name UpdateServer | Select -ExpandProperty UpdateServer)/software/smtp/description.txt") }
			}
			catch
			{ }
		}`
			...
			Param ($Job)
			$result = Receive-Job -Job $Job
			if ($result) { Call-update_notification_psf -Title $UpdateFormText -DescriptionLabel $UpdateDescriptionLabelText -DescriptionText $result -UpdateLabel $UpdateLabelText}
		}
	...
	function Set-Registry
	{
		if ($checkboxSave.Checked)
		{
			...
			[void](Set-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Settings' -Name DisplayName -Value $($textboxDisplayName.Text.Trim()))
	...
	{
		if ((Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Common' -Name KeepConfiguration | Select -ExpandProperty KeepConfiguration) -eq $true)
		{
			$comboboxLanguages.SelectedItem = Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Common' -Name Language | Select -ExpandProperty Language
			$textboxSmtpServer.Text = Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Settings' -Name SmtpServer | Select -ExpandProperty SmtpServer
			$comboboxEncodings.SelectedItem = Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Settings' -Name Encoding | Select -ExpandProperty Encoding
			$comboboxPriority.SelectedItem = Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Settings' -Name Priority | Select -ExpandProperty Priority
			$textboxFrom.Text = Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Settings' -Name From | Select -ExpandProperty From
			$textboxDisplayName.Text = Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Settings' -Name DisplayName | Select -ExpandProperty DisplayName
			$textboxSubject.Text = Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Settings' -Name Subject | Select -ExpandProperty Subject
			$textboxTo.Text = Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Settings' -Name To | Select -ExpandProperty To
			$textboxCc.Text = Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Settings' -Name Cc | Select -ExpandProperty Cc
			$textboxBcc.Text = Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Settings' -Name Bcc | Select -ExpandProperty Bcc
			if ((Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Settings' -Name BodyAsHTML | Select -ExpandProperty BodyAsHTML) -eq $true)
			{ $checkboxAsHTML.Checked = $true }
			else
			{ $checkboxAsHTML.Checked = $false }
			$trackbarFontSize.Value = Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Settings' -Name FontSize | Select -ExpandProperty FontSize
			$checkboxSave.Checked = Get-ItemProperty -Path 'HKCU:\Software\PK-Tools\SMTP Anonymous Access\Configuration\Common' -Name KeepConfiguration | Select -ExpandProperty KeepConfiguration
		}
	}
...
Param($Title, $DescriptionLabel, $DescriptionText, $UpdateLabel)
	...
	$linklabelUpdate.Text = "http://wgo-it000000601/software/smtp/SmtpAnonymousAccess.exe"
